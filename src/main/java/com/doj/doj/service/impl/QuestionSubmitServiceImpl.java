...
import com.doj.doj.constant.CommonConstant;
...
import com.doj.doj.model.enums.QuestionSubmitLanguageEnum;
import com.doj.doj.model.enums.QuestionSubmitStatusEnum;
...
import com.doj.doj.mapper.QuestionSubmitMapper;
import com.doj.doj.service.UserService;
import com.doj.doj.utils.SqlUtils;
...
public class QuestionSubmitServiceImpl extends ServiceImpl<QuestionSubmitMapper, QuestionSubmit> implements QuestionSubmitService{
     ...
     */
    @Override
    public long doQuestionSubmit(QuestionSubmitAddDTO questionSubmitAddRequest, User loginUser) {
        String language =questionSubmitAddRequest.getLanguage();
        QuestionSubmitLanguageEnum languageEnum = QuestionSubmitLanguageEnum.getEnumByValue(language);
        if(languageEnum==null){
            throw new BusinessException(ErrorCode.SYSTEM_ERROR,"编程语言异常");
        }
        // 判断实体是否存在，根据类别获取实体
